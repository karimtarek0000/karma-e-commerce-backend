...
import { confirmEmail, createNewUser, forgetPassword, logOut, refreshToken, resetPassword, signIn } from './auth.controller.js';
import { newUserSchema, resetPasswordSchema, signInSchema } from './auth.validation.js';
...
router.patch('/reset-password/:token', validationCore(resetPasswordSchema), errorHandler(resetPassword));
